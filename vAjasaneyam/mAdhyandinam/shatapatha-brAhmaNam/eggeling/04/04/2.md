...
[^fn_845]: 363:1 Probably, because Soma is slain in being sacrificed (see IV, 3, 4, 1), and therefore belongs to the Fathers or Departed Spirits.
...
[^fn_846]: 363:2 And the All-gods (or all he gods) mean everything. See IV, 4, 1, 4.
...
[^fn_849]: 365:1 Viz., Vāj. S. V, 31, 32. The Āgnīdhra hearth is prepared first, and the Mārjālīya last of the eight dhishṇyas. See p. 148, note 4.
...
[^fn_850]: 365:2 Or, uppermost (uttamam; the Kāṇvas read 'antamām').
...
[^fn_853]: 366:2 In the St. Petersburg Dictionary 'patnīvataḥ' seems to be taken as qualifying 'grahān;' but cp. Rig-veda VIII, 82, 22, 'United with their wives (i.e. the water mixed with the Soma-juice?) these Soma-draughts (sutāḥ) go longing to the rejoicing.'
...
[^fn_854]: 367:1 'īś,' etymologically connected with 'own.'
...
[^fn_855]: 367:2 Or, wived, mated one, 'patnīvan;' the Kāṇva text reads 'Agne Vāc patni.' See preceding page, note 2.
