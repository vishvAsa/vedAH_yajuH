...
[^fn_620]: Antaḥpavitrāt, lit. from (the vessel or stream of Soma) which has the strainer inside it; the straining-cloth being spread over the Droṇakalaśa, into which the pressed-out Soma-juice is poured. The Petersburg Dictionary assigns to it the meaning 'the Soma within the filtering vessel' (see ). Perhaps it means 'from that which has a strainer between,' i.e. from the poured-out stream from which the libation is taken, and which is separated from the Droṇakalaśa by the straining-cloth.
...
[^fn_624]: This refers to the formula 'This is thy womb,' with which most libations, after being drawn, are deposited in their proper place on the khara until they are used for offering. See .
...
[^fn_625]: 'Were he to offer both after sunrise, there would only be day, and no night; and were he to offer both before sunrise, there would only be night, and no day.' Kāṇva text.
...
[^fn_626]: Tasmād y idaṁ rātrau tamasi sati nirjñāyata iva kiṁcid iva. Kāṇva text.
...
[^fn_627]: Viz. from the stream of Soma poured from the Hotr̥'s cup on the straining-cloth. See , note .

[^fn_628]: See , with note.
...
[^fn_629]: Mahīdhara offers the alternative interpretation, 'through thee I place day and night between (Soma and the enemies),' which is also Sāyaṇa's interpretation on Taitt. S. I, 4, 3; as apparently that of the Taitt. S. itself, VI, 4, 6.
...
[^fn_631]: This does not appear to refer to the Taittirīyas, since by them the same order of proceeding is prescribed for the Antaryāma as for the Upāṁśu (, note ); cf. Sāyaṇa on Taitt. S. I, p. 603. See, however, Maitrāy. Saṁh. I, 3, 4-5.

[^fn_632]: 'Apīd (vai)' seems to have much the same meaning ('perhaps') as the later 'api nāma.' Cf. I, 9, 1, 19.
...
[^fn_633]: He offers the entire Soma in the Antaryāma cup, without leaving any, or pouring any juice into the Āgrayaṇasthālī.
...
[^fn_634]: According to the Kāṇva text he is to place the Antaryāma cup on the south-east corner (dakshiṇārdhe) of the khara (see , n. ); while, according to Kāty. IX, 2, I, both the Upāṁśu and Antaryāma are to be placed on the north-east corner, the former south of the latter. This arrangement, however, would scarcely agree with -. The Upāṁśu-savana stone, doubtless, is to lie between the two cups, with its face towards the Upāṁśu.
