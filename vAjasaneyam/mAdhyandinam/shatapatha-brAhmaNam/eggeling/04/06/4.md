...
[^fn_996]: Or, the thought-swift (manojū).

[^fn_997]: For the different meanings of 'vāja' see Max Müller, 'India, what can it teach us?' p. 164.

[^fn_998]: Or, in all our invocations (havana).

[^fn_999]: The identification of Viśvakarman with Indra was probably suggested by the final pāda of the preceding verse of the hymn (Rig-veda X, 81, 6): 'May there be (or may he, Viśvakarman, be) for us a Sūri Maghavan' (a rich patron; terms frequently applied to Indra). But cp. Muir, O. S. T. vol. iv, p. 7.
...
[^fn_1000]: The Kāṇva text does not give the verse, but remarks merely,--But if he can get (vindet) an aindrī vaiśvakarmaṇī (verse), let him draw it therewith.
...
[^fn_1001]: I see no other way of rendering 'yathā-asat' in this passage.
