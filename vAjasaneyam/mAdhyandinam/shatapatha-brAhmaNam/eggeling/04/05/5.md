...
[^fn_944]: That is, in mixed flocks. In the compound 'ajāvika' (Kāṇv. ajāvayaḥ, αἶγες καὶ ὄϊες) also the goats come first.
...
[^fn_945]: Perhaps 'ara' has to be taken in the sense of 'quick, nimble,' instead of 'spokes,' and 'ḍītara' might mean 'flying up,' 'popping up their heads,' as opposed to 'avācīnaśīrshan.'
...
[^fn_946]: ? Or, three (times) two, 'dvau trīn iti;' the Kāṇva text reads (of goats alone) 'trīṁs trīn.'
...
[^fn_947]: Or, along with, correspondingly with, anu.

[^fn_948]: Or, connected with Indra, Indra's own (aindra).
...
[^fn_949]: The two R̥tupātras are shaped like spoon-bowls, with spouts on both sides.
...
[^fn_950]: Or, smells, sniffs at them (as a cow does the calf).
