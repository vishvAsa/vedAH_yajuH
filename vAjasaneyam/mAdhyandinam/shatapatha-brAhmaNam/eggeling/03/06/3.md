...
[^fn_411]: That is, a blood-relation of the sacrificer, dwelling together with him. Cf. also , note .
...
[^fn_412]: Viz. on the Āhavanīya of the Prācīnavaṁśa (hall) now serving as the Gārhapatya, and generally called śālādvārya, i.e. the one near the (front or eastern) hall-door.
...
[^fn_414]: Pr̥shad-ājya (lit. mottled butter) is clarified butter mixed with sour milk.
...
[^fn_415]: He offers some ghee from a substitute spoon (pracaranī), as the proper offering-spoons now filled with ghee and clotted ghee have to be carried with the fire to the Āgnīdhra.

[^fn_416]: Mahīdhara explains 'tanūkr̥t' by 'tanūṁ kr̥ntanti cindanti.' It ought rather to mean 'body-making,'--? from the enemies that assume (various) forms.'
...
[^fn_418]: The 'Vāyavya' are wooden cups shaped like a mortar. It seems here to include all the Soma-cups, see IV, 1, 3, 7-10; Kāty, VIII, 7, 5.

[^fn_419]: See -.

[^fn_420]: Viz. at the guest-offering, see , note . It was tied up with the three objects mentioned immediately before.

[^fn_421]: The vapāśrapaṇī are sticks of kārshmarya wood.

[^fn_422]: For these objects, see , note .

[^fn_423]: 'Thus that sacrifice goes upwards to yonder heavenly world, and, the sacrifice being the sacrificer, the sacrificer thus goes thither,' Kāṇva text. See , where the gods are said to have attained immortality from the Āgnīdhrīya.
...
[^fn_424]: Also the two fringed filtering-cloths (daśāpavitre), according to the Kāṇva rec.
...
[^fn_425]: 'He then deposits the Prastara on the mound (, note ), deposits there the juhū and the upabhr̥t and the pr̥shadājya; and having touched the sacrificial materials and touched water, he takes the king and enters (the cart-shed),' &c. Kāṇva rec.
...
[^fn_427]: Thus (iti), viz. with the following modifications of the corresponding formula, used at the 'intermediary consecration,' . Perhaps 'iti' may mean 'thus,' i.e. while still keeping his fingers turned in; or, it may mean 'as such' (as a free man).
