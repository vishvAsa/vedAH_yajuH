...
[^fn_135]: 'Yours (shall be) Soma, and ours Vāc, wherewith you bought (Soma) from us.' Kāṇva text.

## 05
5. The Gandharvas recited the Vedas to her, saying, 'See how we know it, see how we know it [^fn_136]!'

[^fn_136]: The G. proclaimed the sacrifice and Veda to her, saying, 'Thus we know the sacrifice, thus we know (the Veda); mighty are we.' Kāṇva text.
...
[^fn_137]: 'And hence it is to him who is given to vain things, who dances and sings, that women are most attached.' Kāṇva text.
...
[^fn_138]: Literally, 'that he may sacrifice with the arrived (guest) for his own arrival (? in the world of the gods).'

sacrifices with Soma that has not been bought, sacrifices with Soma that has not been (properly) obtained [^fn_139].

[^fn_139]: Lit. 'with Soma that has not come' (to him as a guest), so that the guest-offering (ātithya, ) could not take place.
...
[^fn_140]: Because of this piece of gold, the offering here described is called Hiraṇyavatī-āhuti, or 'offering with gold.'

[^fn_141]: See II, 1, 1, 5; 3, 1, 15.
...
[^fn_142]: The author seems to take jūḥ here as nom. of jur = gur (gr̥, gir), cf. jūrṇi. Some of the native dictionaries give jū as one of the names of Sarasvatī. The St. Petersb. Dict. takes it here in the sense of 'drängend, treibend (pressing forward).'
...
[^fn_143]: Mano hīdaṁ purastād vācaś carati, Kāṇva text.
...
[^fn_145]: The concluding ceremonies of the Prāyaṇīya (see ) are now performed; the offering of the Barhis being optional, as the barhis may be used again for the Udayanīya (ib. 22). Katy VII, 6, 11 comm.
...
[^fn_146]: According to the Kāṇvas, the Adhvaryu's formula is,--Ihi, Yajamāna, 'Go, Sacrificer!' In Kāty. VII, 6, 1 2 only the above formula is mentioned.

[^fn_147]: The eastern door is for the Adhvaryu (and Sacrificer) and the southern for the Pratiprasthātr̥.

[^fn_148]: Soma-krayaṇī, 'the cow for which the Soma-is bought.'

[^fn_149]: Prahitaṁ seems to be taken here in the double sense of 'put forward or in front' (from pra-dhā) and despatched (from pra-hi).
...
[^fn_150]: 'In accordance with the thought of the mind,' manaso vai cittam anu vāg vadati, K.

[^fn_151]: The omission of 'asi' in the Brāhmaṇa is curious; the Kāṇva text has correctly 'dakshiṇāsi.'

[^fn_152]: Dhiyā-dhiyā, or rather 'by means of this their respective genius (in regard to speech).' Dhī seems to mean 'thought expressed by speech,' hence often 'prayer, hymn;' cf. .

[^fn_153]: Prakāmodya, rather either 'fondness for talk' or 'effusive speech.' It seems to refer to story-tellers (? amusing speech).
...
[^fn_154]: In Taitt. S. VI, 1, 7, 5, this epithet is explained by the fact that both the prāyaṇīya and the udayanīya belong to Aditi.
...
[^fn_155]: 'And her he thereby makes the guardian on his path,' imām evāsmā etad adhvani goptāraṁ karoti, K.
...
[^fn_156]: Rudra rules over these (cows); the cattle do not pass beyond (nātiyanti) him; and thus she does not pass beyond him: therefore he says, 'May Rudra turn thee back!' Kāṇva text.
