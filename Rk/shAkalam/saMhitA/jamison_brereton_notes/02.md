...
expression: “whose common meal (it is)” à “who has a common meal,” further extended to “who offers a common meal.” I find this more satisfying syntactically
...
lengthen vowels before elements beginning with v, not only the augment, but preverbs, and 1st cmpd. members, presumably spreading from forms that originally
...
radical sibilants and the desiderative suffix. The finite verb ví śikṣa in IV.35.3 (also a Ṛbhus context) belongs here as well. Heenen (Desid., 232-33) mentions this
...
yugā́and kṣápaḥ), and there is also one in 8a, uṣáso rā́myāḥ, that is very similar to the phrasing here. If the phrase is interpr. as acc., the subject to be supplied would
...
elsewhere construed only with ‘udder’ (ū́dhar-, II.34.2, 10; cf. also IV.3.10) or ‘milk’ (páyaḥ, VI.48.22); though it is true that the alternative gen. pṛ́śneḥ is found with
...
### 06-07
6c and 7c are paraphrases of each other. Each contains a dual referring to
...
parallel (e.g., 2a in this hymn), I am somewhat reluctant to adopt this interpr. The standard tr. (Old [SBE], Ge, Re, WG) take dīdet as a modal, but it is
...
sacrifice, is not impossible. Ge considers it attraction from *yásya … yajñám, but a loose purpose/goal accusative, almost a pseudo-infinitive “to sacrifice,” seems
...
but then, as a sort of secondary or double bahuvrīhi, ‘having [/receiving] (hymns) with good twists’. In this meaning it is parallel to suprayásam ‘having [/receiving]
...
### 02-03
As IH pointed out to me, dvitā́dadhur in 2b can be read, contra Pp. adadhur,
...
nights” with the standard tr., because I could not otherwise account for the ā́. Narten’s tr. (KlSch 370 n. 5) is similarly intransitive though with a temporal, rather
...
The standard tr. must construe gúhā with vanvántaḥ ‘gaining in secret’ (e.g., Ge “heimlich überbieten und uüberwinden”). Although this is the obvious way to
...
specifying vócat. This chaotic diversity shows that we interpreters are uncertain not only about the syntax of the verse but the sense. In what follows I will pursue this
...
whole, adding to the confusion by attributing an unusual sense to abhavat should be avoided if at all possible. It might be possible to read the injunctives vócat and véḥ
...
mechanism of the identifications that have run through the hymn has been laid bare, the poet briskly finishes up the hymn, beginning with the summary 2nd hemistich
here.
...
Agni
### 01-04
The #ya(śástamasya) that opens 1c anticipates the forms of the relative
...
### 04-06
As the just-mentioned structural device expires in 4a, another takes its
...
abhí). Since ádhi is the 2nd word in 5c, only 6b is not part of the chain. ### 04-05
On the disguised Svarbhānu myth in these two vss., see publ. intro. Most
...
unchallenged. Gr assigns -vidatra- to dā1 ‘give’+ ví and glosses it ‘vertheilend’. (That √dā is not otherwise found with ví speaks against this derivation.) In his brief
...
madhupṛ́cam ‘mixing with honey’ reminds us of the later Madhuparka drink offered to distinguished visitors, but I doubt that such a reference is found here. Though it
...
cl. embedded, since the main clause in cd must include túbhyéd that begins c, parallel to vāyáve in d. Another wrinkle is the fact that the verbal predicate of this 2nd rel.
...
come to mean ‘stay, block’, with rivers (bzw. waters) as obj. Cf. III.53.9 ástabhnāt síndhum arṇavám “he stayed the river in flood,” depicting Viśvāmitra’s feat in
...
“the mountain, though about to run, has come to rest,” rather than “even the mountain …” Note the use of the future participle to express past prospective value
...
semantically or functionally. The only possible (but weak) motivations I can see for the use of different stems are 1) metrical (neut. pl. puṣṭā́ni would not fit in 5c;
...
### 09-11
Note the phonological sequence, with several different interlocking
repetitions:
9c yó víśvasya
...
śúṣmāt, while the geographical feature corresponding to H+E in a, namely párvatā(ḥ) ‘mountains’, is postponed. But surely the clause means “even the mountains fear his
...
tásyā(ḥ) is the immediately preceding jánitrī, which refers to the season, so an abl. of water is unlikely. That pári might form a lexeme with ā́viśat is suggested by 8c
ápariviṣṭam.
...
with the same syntactic pattern as is suggested here. There is also an occurrence of the same stem saṃdṛ́ś- in the acc. pl. in 10c, but this seems to have no clear
...
enough to derail it.) I further think that the last bit of the hemistich, vy àvánīr ádhārayaḥ, is a
...
“What (deeds) you have done, you are worthy of hymns with regard to all of them.” But somehow I doubt that’s what the poet intended -- though what his intentions
...
sg. impv. is vīhí (7x). The easiest way to explain its short vowel is by analogy to ihí belonging to the root pres. to √i ‘go’, with pres. indic. émi, éṣi, éti, and impv. étu, all
...
depends to some extent on what root we ascribe it to. I will not rehearse the various suggestions; suffice it to say that I think it belongs with √sā ‘bind, tie’ and refers to
...
and the masc. beneficiary. I have no confidence that my interpr. of this vs. is correct, but I find the other
...
conspectus of dhā forms, I found only one example of pári √dhā ‘deliver’, namely our pári dhehi. I wonder if dhehi for *dehi is a nonce hypercorrection, for a form that
...
verb (kṛṇve, flg. Ge) that has no support. I think rather that it signals a standard syntagm that has been split across the vs.: “the still and the moving” (gen. sthātúr
...
is a way of referring to the day of the sacrifice. Most forms belonging to the thematic stem dábha- must be root aor.
...
of the subject of the rel. cl. in pāda a, namely the over-zealous sacrificer. The verb áva … diṣīya belongs not with √dā ‘give’ (with Gr), but √dā ‘cut, divide’ (so already
...
way. kalmalīkín- is obviously a possessive -ín-stem built to a -ka-suffixed form of
...
after the verb occupying post-caesura position (e.g. … dáyase ví … VI.37.4, VII.23.4). Although the preverb is not found here, víśvam immediately follows the
...
### 02-05
Note the concentration of pṛSIB forms: 2d pṛ́śni
yāḥ, 3d prk̥ ṣám …
...
Prś̥ ni milk the gleaming (milk/semen) from the udder.” See also VI.48.22 and comm. ad loc., which may also refer to the birth of Rudra/his semen as occurring before the
...
correspondent in a compound: loc. vayúneṣu matches dhūr- and both are governed by the cmpd 2nd member -sád-, at least in my interpr. (guided by Th., Unters., 23); the
...
supposed loc. (the only loc. to this stem in the RV) is immediately followed by ā́ (bhága ā́), which resembles the dat. bhágāya with quantity flip. If this seems too
...
(VRS), Doniger, Maurer.
### 01-04
The first words of each hemistich in this series of vss. echo each other: 1a
...
arí- (or nom. pl., though this would not fit syntactically). ### 03-04
These two vss. are closely knit together verbally. Both contain an
...
from the ppl. kṛtá- (or rather fem. kṛtā́-) on the basis of AiG II.1.19-20, where substantivized adjectives retract their accent. This seems the best hypothesis of a
...
Napāt with Agni that brings the hymn to its climax is only partially complete here, and the poet is being canny about not directly referring to fire, though at the same
...
name of Agni.
### 10-11
The ends of the d pādas in these vss. are very similar: 10d … ánnam
...
in the publ. intro., that the waters bring him ghee brings the watery and the fiery into harmony. Note that the waters as his cloak here (if I am correct in this interpr., see
...
second action depends on the first. Despite the masc. gender of devébhiḥ, I do not think it identifies a different
...
### 01-03
The d pādas of the first three vss. have a rigid structure: PRIEST’S CUP
...
the draught animals of a and vīḍayasvā in b -- point rather to the chariot. See VI.47.26 cited by both Ge and Re. Why the chariot is addressed and identified with
...
### 07-08
These two vss. have been variously interpr. My interpr. is most influenced
...
enjambment, I see no better choice, and note that a new clause also begins in the middle of pāda c (with nákiḥ) and continues to the end of d. Sim. also 9c. Ge’s
...
plainly in the next vs., 9ab. It is esp. striking that Varuṇa follows Savitar’s vratá-, since the vratá- is primarily Varuṇa’s domain. That Varuṇa is the only god named
...
III.119, 129), I tr. it as a pl., since we usually hear of “wives (of the gods)” - though, since I don’t exactly know what Narāśaṃsa (=Agni?) is doing here, perhaps there’s
...
middle one of which could also be an impv. Ge takes all three as preterital, a course I also follow, but Re takes gūhatām as impv. (flg. Gr); WG take the first two as
...
simultaneously applied. In the publ. tr. vṛ́ṣaṇā appears to be tr. as a voc.; it is not, and the tr. might be
...
Various gods
### 01-03
This tṛca is characterized by lexical chaining. The first pāda of vs. 2
...
or gods. Ge (n. 3b) suggests that it is a metrically conditioned “hypallage” for dual niyútvantā, which would qualify Indra and Vāyu. This is a clever idea and would
